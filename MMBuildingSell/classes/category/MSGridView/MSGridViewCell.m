...
-(void)layoutSubviews
{
    ...
    [self.contentView setFrame:CGRectMake(contentbuffer, contentbuffer2, self.frame.size.width-contentbuffer*2, self.frame.size.height-contentbuffer2*2)];
    [self.contentLabel setFrame:CGRectMake(contentbuffer, contentbuffer2, self.frame.size.width-contentbuffer*2, self.frame.size.height-contentbuffer2*2)];
}
