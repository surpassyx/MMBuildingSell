...
//    fangDaiBar = [[OANavigationBar alloc]initWithFrame:CGRectMake(POSLEFTX, 0, 640, 44) BackImage:[UIImage imageNamed:@"zx_top.png"]];
//    fangDaiBar.title = @"房贷计算器";
//    [self.view addSubview:fangDaiBar];
    
    userContentView = [[UIScrollView alloc]initWithFrame:CGRectMake(POSLEFTX, 44, 320, self.view.frame.size.height-44)];
...
{
    //添加背景滚动视图
    coverScrollview = [[UIScrollView alloc]initWithFrame:CGRectMake(320 + POSLEFTX, 44, 320, self.view.frame.size.height-44)];
...
-(void)creatPopView
{
    ...
    //背景层
    coverView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 640, self.view.frame.size.height)];
...
-(void)addViewOne
{
    ...
    //标题1
    UILabel * label_1_1 = [[UILabel alloc]initWithFrame:CGRectMake(20, 3, 300, 20)];
    label_1_1.backgroundColor = [UIColor clearColor];
    label_1_1.font = [UIFont systemFontOfSize:14];
    label_1_1.textColor = [UIColor grayColor];
    label_1_1.text = @"以上结果仅供参考。";
    [btnView addSubview:label_1_1];

    //标题2
    UILabel * label_2_2 = [[UILabel alloc]initWithFrame:CGRectMake(20, 25, 300, 20)];
    label_2_2.backgroundColor = [UIColor clearColor];
    label_2_2.font = [UIFont systemFontOfSize:14];
    label_2_2.textColor = [UIColor grayColor];
    label_2_2.text = @"房产计算结果最终以实际交易金额为准。";
    [btnView addSubview:label_2_2];
    //分割线
...
-(void)addViewTwo
{
    ...
    btnView.backgroundColor = [UIColor clearColor];
    //标题1
    UILabel * label1 = [[UILabel alloc]initWithFrame:CGRectMake(20 , 3, 300, 20)];
    label1.backgroundColor = [UIColor clearColor];
    label1.font = [UIFont systemFontOfSize:14];
    label1.textColor = [UIColor grayColor];
    label1.text = @"以上结果仅供参考。";
    [btnView addSubview:label1];

    //标题2
    UILabel * label2 = [[UILabel alloc]initWithFrame:CGRectMake(20, 25, 300, 20)];
    label2.backgroundColor = [UIColor clearColor];
    label2.font = [UIFont systemFontOfSize:14];
    label2.textColor = [UIColor grayColor];
    label2.text = @"房产计算结果最终以实际交易金额为准。";
